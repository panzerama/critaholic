...
class InitiativeTestForm(TestCase):
    ...
    def test_initiative_form_renders_correct_css(self):
        ...
        self.assertIn('class="col-md-4 form-group" id="id_creature_name"', init_form.as_p())
        self.assertIn('class="col-md-4 form-group" id="id_initiative_value"', init_form.as_p())
        self.assertIn('class="col-md-4 form-group" id="id_hit_points"', init_form.as_p())
